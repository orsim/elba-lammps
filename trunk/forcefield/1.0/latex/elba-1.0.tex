...
%\newcommand{\citeALlpp}{\cite{lindahl00b,gulli04,patra05,sonne05,carrillo05,gulli06,olli07,ollila07}}
%\newcommand{\citeCGlpp}{\cite{xiang94,ventu99,brann04b,frink06,goetz98a,shillcock02,branniganFlex05,frisch05b}} %illya05,
...
%The interaction between lipids and proteins in biological membranes: theory, simulations and experiments\\
% Understanding biological membranes by multiscale simulations: lipid-protein interplay, bilayer regulation of anaesthesia and membrane-nanomaterial interactions
%
}
 % 100 characters max
...
%\markright{Quantitative CG model for lipid bilayers} % 40 characters max
...
%$\epsilon_{AA}$ & 3.5\,kJ/mol &&\\
%$\epsilon_{PP}$ & 6.0\,kJ/mol&&\\
$\epsilon_{GG}$, $\epsilon_{EE}$ & 4.0\,kJ/mol & 0.956\,kcal/mol&\\
%$\epsilon_{EE}$ & 4.0\,kJ/mol &&\\
...
is identified by $w$. The rigidity of the dipole orientation-restraining potential %(equation~\ref{eq:orientRestrain}) 
