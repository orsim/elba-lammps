...
# Syntax: python numDens2elecDens.py inputFile nElectrons
# Example: python numDens2elecDens.py numDensChol.zProfile 50 > edpChol.dat
...
if len(sys.argv) != 3:
  print "Syntax: python numDens2elecDens.py inputFile nElectrons"
  sys.exit()
