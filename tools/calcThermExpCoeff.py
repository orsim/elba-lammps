...
# Syntax: python calcThermExpCoeff.py rho1 rho2 T1 T2
#         rho1 = density at T1
#         rho2 = density at T2
#         T1 = temperature [K]
#         T2 = temperature [K]
# Example: python calcThermExpCoeff.py 1.002 0.996 298 318
...
if len(sys.argv) != 5:
  print "Syntax: python calcThermExpCoeff.py rho1 rho2 T1 T2"
  sys.exit()
